# Azure Functions Development & Deployment Quick Reference
...
### 3.1 Create HTTP Trigger Function

```
func new --template "HttpTrigger" --name SubmitOrder
```

### 3.2 Create Queue Trigger Function
...
## 6. Build, Package, and Deploy to Azure
...
## 7. Test Function API with APIM (Replace token from login response)
...
## 8. How APIM and Function App Trigger Flow Works
...
## 9. OrderProcessing Function App Trigger Flow

### HTTP Trigger (SubmitOrder)
...
## 10. Queue Trigger (ProcessOrder) with Blob Storage Output
